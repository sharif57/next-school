...
const Page = () => {
    return <div>
        <div className="h-96 flex items-center justify-center bg-gradient-to-r pt-20 mb-32">
            <div className="relative">
                ...
                <div id="form-container" className="bg-white  px-6 py-4  rounded-lg shadow-2xl w-80 relative z-10 transform transition duration-500 ease-in-out">
                    ...
                    <form className="space-y-5">
                        ...
                        <Link href={'/register'} className="text-blue-500 hover:text-blue-800 text-sm" >
                          Have all ready account? Login Page
                        </Link>
                    </form>
                </div>
            </div>

...
const Navbar = () => {
    return <div>
        <header className="fixed top-0 left-0 w-full p-4 dark:bg-gray-100 text-black dark:text-gray-800 bg-slate-200 opacity-90 z-50 ">
            <div className="container flex justify-between h-16 mx-auto">
                ...
                <div className="items-center flex-shrink-0 hidden lg:flex">
                    ...
                    <Link href={'/register'} className="self-center px-8 py-3 font-semibold rounded dark:bg-violet-600 dark:text-gray-50">Sign up</Link>
                </div>
